...
func main() {
	...
	// 解析命令行参数
	flag.BoolVar(&common.Debug, "d", false, "Debug mode")
	if cfg.ParseFlags() {
		return // 显示版本后退出
	}
	...
	// Note: service.DebugF has been replaced by log.DebugF throughout the codebase
	// This line is removed to avoid import cycle
